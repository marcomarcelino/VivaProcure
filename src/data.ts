...
export const TRANSLATIONS = {
  id: {
    ...
    bantuan: 'Bantuan',
    logout: 'Keluar',
    taniMakmur: 'Koperasi Sumber Makmur',
    sumberMakmur: 'Koperasi Padiwangi',
    ...
    firstPartyCoopName: 'Koperasi Sumber Makmur',
    ...
    warningCapacityTitle: 'Peringatan Kapasitas: Koperasi Melati Jaya',
    warningCapacityDesc: 'Berdasarkan data historis dan laporan saat ini, Koperasi Melati Jaya mendekati batas maksimal kapasitas penyimpanan (92% penuh). Disarankan untuk menjadwalkan pengambilan lebih awal.',
  ...
  en: {
    ...
    bantuan: 'Help',
    logout: 'Logout',
    taniMakmur: 'Sumber Makmur Cooperative',
    sumberMakmur: 'Padiwangi Cooperative',
    brandTitle: 'VivaProcure',
    ...
    firstPartyCoopName: 'Sumber Makmur Cooperative',
    ...
    firstPartySignText: 'H. Ahmad Subarjo',
    firstPartyTitle: 'Chairman of Sumber Makmur Cooperative',
    ...
    warningCapacityTitle: 'Capacity Alert: Koperasi Melati Jaya',
    warningCapacityDesc: 'Based on historical data and current records, Koperasi Melati Jaya is reaching maximum storage limits (92% full). Early transport scheduled is advised.',
...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        description: 'Logistik tiba di Gudang Utama Koperasi Sumber Makmur dan siap dilakukan bongkar muat.',
